...
export function Navbar() {
  return (
    <nav className="flex items-center justify-between px-8 py-3 bg-[#F3F3F3] border-b border-gray-200">
      {/* Logo */}
      ...
      {/* Navigation Links */}
      <div className="hidden md:flex items-center gap-12  font-bold text-xs tracking-[1.8px] text-[#4b4036] ">
      ...
      <div className="flex items-center">
        <button className="p-2 hover:bg-gray-200 rounded-full transition-colors cursor-pointer" aria-label="Search">
          <Search size={32} className="text-[#333]" strokeWidth={1.5} />
        </button>
      </div>
    </nav>
  );
